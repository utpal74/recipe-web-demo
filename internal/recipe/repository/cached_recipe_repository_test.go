...
type mockRepository struct {
	...
	createFunc   func(context.Context, domain.Recipe) (domain.Recipe, error)
	getByIDFunc  func(context.Context, domain.RecipeID) (domain.Recipe, error)
	getAllFunc   func(context.Context) ([]domain.Recipe, error)
	updateFunc   func(context.Context, domain.Recipe) (domain.Recipe, error)
...
func (m *mockRepository) Create(ctx context.Context, recipe domain.Recipe) (domain.Recipe, error) {
	if m.createFunc != nil {
		return m.createFunc(ctx, recipe)
	}
	recipe.ID = domain.RecipeID("mock-id-" + time.Now().Format("20060102150405"))
	m.recipes = append(m.recipes, recipe)
	return recipe, nil
}

func (m *mockRepository) GetByID(ctx context.Context, id domain.RecipeID) (domain.Recipe, error) {
...
func (m *mockRepository) GetAll(ctx context.Context) ([]domain.Recipe, error) {
	if m.getAllFunc != nil {
...
func (m *mockRepository) Update(ctx context.Context, recipe domain.Recipe) (domain.Recipe, error) {
	if m.updateFunc != nil {
...
func (m *mockRepository) Delete(ctx context.Context, id domain.RecipeID) error {
	if m.deleteFunc != nil {
...
func (m *mockRepository) GetByTag(ctx context.Context, tag string) ([]domain.Recipe, error) {
...
func (m *mockRepository) CreateMany(ctx context.Context, recipes []domain.Recipe) error {
